...
public class RabbitConfig {
    ...
    public static final String DIRECT_EXCHANGE = "msg_exchange";
    ...
    public Queue msgQueue() {
        ...
        args.put("x-message-ttl", 0); // 给队列设置过期时间，0表示到达队列后马上过期
        args.put("x-dead-letter-exchange", RabbitDlxConfig.DEAD_LETTER_EXCHANGE); // 设置死信交换机
        args.put("x-dead-letter-routing-key", RabbitDlxConfig.DEAD_LETTER_QUEUE); // 设置死信队列的routing-key
